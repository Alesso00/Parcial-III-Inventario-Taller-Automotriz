...
if ($opcion == 1) {
    try {
        $query = "INSERT INTO inventario (id_repuesto, id_marca, id_modelo, year, entrada, salida, stock, costo, fecha) 
       VALUES (:repuesto, :marca, :modelo, :year, :entrada, :salida, :stock, :costo, :fecha)";
        ...
        header("Location: ..//Dashboard/New_inventario.php");
        exit();
