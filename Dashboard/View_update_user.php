  ...
  <div class="form-container">
    ...
    <input type="text" name="opcion" value="6" hidden>
      ...
      <div class="input-group">
        <label>Nombres:</label>
        <input type="text" name="nombre" required value="<?php echo $usuario['Nombre'];?>">
      </div>
      <div class="input-group">
        <label>Apellidos:</label>
        <input type="text" name="apellido" required value="<?php echo $usuario['Apellido'];?>">
      </div>
      <div class="input-group">
        <label>Nombre de Usuario:</label>
        <input type="text" name="nombre_usuario" required value="<?php echo $usuario['usuario'];?>">
      </div>
      <div class="input-group">
      ...
      <div class="button-group">
        <input type="submit" value="Modificar" id="modificar_usuario">
      </div>
    </form>
</body>
