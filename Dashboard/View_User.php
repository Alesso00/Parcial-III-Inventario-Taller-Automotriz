    ...
    <table class="table  table-hover" >
        ...
        <tbody>
            ...
            foreach ($usuario as $usuario) {
                ...
                echo "<td><form action='View_Update_user.php' method='POST'>
                <input type='text' name='id' value='".$usuario['id']."' hidden >
               <input type='submit' class='btn btn-success' value='Modificar'>
               </form></td>";

                echo "<td><form action='../Delete/Delete_user.php' method='POST'>
                        <input type='text' name='id' value='".$usuario['id']."' hidden >
...
<a class="btn btn-success" aria-current="page" href="New_User.php">Registrar Usuario</a>
</section>
